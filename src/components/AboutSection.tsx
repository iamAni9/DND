...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative w-full max-w-[1400px] mx-auto rounded-[48px] bg-[#0A0A0B] border border-white/5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.7)] overflow-hidden py-16 px-6 md:px-16 flex flex-col items-center justify-center mt-6">
      ...
      <div className="relative flex flex-col justify-start items-start w-full max-w-[936px] group mx-auto z-10">
        ...
        <div 
          className="absolute inset-0 opacity-40 rounded-[40px] pointer-events-none z-0 filter blur-[50px] transition-opacity duration-700 group-hover:opacity-65 animate-spin-border"
          style={{
        ...
        <motion.div
          ...
          className="relative z-10 w-full rounded-[40px] overflow-hidden border-8 border-transparent animate-spin-border self-stretch"
          style={{
        ...
        >
          ...
          <div className="w-full h-full p-8 md:p-12 lg:p-16 flex flex-col justify-between bg-transparent">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 w-full">
              ...
              <div className="lg:col-span-5 flex flex-col justify-start items-start">
                ...
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-semibold text-sky-400 tracking-wider uppercase mb-6 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
                  <Sparkles className="w-3.5 h-3.5 text-[#7DD3FC] animate-pulse" />
                  About Dev Next Door
                </div>

                {/* Headline */}
                <h2 className="text-white font-medium text-3.5xl md:text-4xl lg:text-4.5xl leading-[1.15] tracking-tight text-left">
              ...
              <div className="lg:col-span-7 flex flex-col gap-6">
                ...
                {/* Paragraphs */}
                <div className="flex flex-col gap-5 text-gray-400 text-[15px] md:text-[16px] leading-[1.7] font-normal selection:bg-white/20">
                  <p>
