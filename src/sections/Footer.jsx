  ...
  return (
    <footer className="footer" aria-labelledby="footer-brand">
      ...
      <div className="footer-container">
        ...
        <div className="footer-links-container">
          <div className="footer-col">
            <h4 className="footer-col-title font-solid">Explore</h4>
          ...
          <div className="footer-col">
            <h4 className="footer-col-title font-solid">What We Build</h4>
            <ul className="footer-col-links">
              <li><a href="#">SaaS Systems</a></li>
              <li><a href="#">AI Companions</a></li>
        ...
        <div className="footer-newsletter">
          <h4 className="footer-col-title font-solid">Stay Updated</h4>
          <p className="footer-newsletter-desc">
            Subscribe to our newsletter for insights on design, tech, and startup scaling.
          </p>
      ...
      <div className="footer-bottom">
        <p className="footer-copyright font-solid">
